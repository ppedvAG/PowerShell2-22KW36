...
Write-Verbose -Message "Ich werde bei -Verbose mit ausgegeben"
Write-Host -Object (Get-Date).ToShortTimeString() -ForegroundColor Green
}
...
$Zeitpunkt = Get-Date
Write-Debug -Message "Vor Ausgabe"
Write-Host -Object $Zeitpunkt.ToShortTimeString() -ForegroundColor Green
}
